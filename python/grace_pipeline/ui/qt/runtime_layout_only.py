...
def compact_processing(window):
    ...
    for card in (page.card_time_range, page.card_inversion, page.card_grid_settings, page.card_filters, page.card_sh_tools):
        card.setParent(wrapper)
        card.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Maximum)
    page.card_filters.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
    grid.addWidget(page.card_time_range, 0, 0)
    grid.addWidget(page.card_inversion, 1, 0)
    grid.addWidget(page.card_grid_settings, 2, 0)
    grid.addWidget(page.card_filters, 0, 1, 2, 1)
    grid.addWidget(page.card_sh_tools, 2, 1)
